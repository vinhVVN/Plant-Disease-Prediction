...
def _make_divisible(v, divisor=8, min_value=None):
    ...
    This is standard practice in MobileNet implementations.
    """
...
class SE_Module(nn.Module):
    def __init__(self, exp_size, squeeze_channels):
        ...
        Uses Conv2d 1x1 to mathematically match the paper and PyTorch's framework structure.
        """
...
class Bneck(nn.Module):
    def __init__(self, in_channels, exp_size, out_channels, kernel_size, stride, use_se, nl_class):
        ...
        Handles expansion, depthwise convolution, and projection.
        """
